...
class PDF extends FPDF {
    function Header() {
        ...
        $this->Cell(0, 10, 'Monrine Enterprise', 0, 1, 'C');
    ...
    function Footer() {
        ...
        $this->Cell(0, 10, 'Generated by Monrine  Enterprise - ' . date("Y-m-d"), 0, 0, 'C');
    }
}
...
Welcome to Monrine Enterprise Apartments! We are delighted to have you as a potential tenant.
...
We look forward to a great stay with you at Monrine  Enterprise Apartments.");
